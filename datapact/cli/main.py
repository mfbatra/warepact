...
from datapact.cli.check import check_command
from datapact.cli.diff import diff_command
from datapact.cli.generate import generate_command
from datapact.cli.init import init_command
from datapact.cli.publish import publish_command
from datapact.cli.report import report_command
from datapact.cli.watch import watch_command
...
def mcp_command(
    ...
    from datapact.cli._console import console
    try:
        from datapact.mcp.server import run_server
