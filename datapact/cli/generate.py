"""datapact generate — AI-generate a contract YAML from a warehouse table."""
...
from datapact.cli._ai_enrichment import enrich_contract
from datapact.cli._console import console, err_console
from datapact.cli._credentials import load_credentials
from datapact.cli.check import _autodiscover
from datapact.core.exceptions import UnknownWarehouseError
...
def generate_command(
    ...
    console.print(
        ...
        f"then run [bold]datapact check {contract_name}[/]"
    )
