...
from datapact.core.engine import ContractCheckResult, ContractEngine
from datapact.core.exceptions import ContractCheckError, ContractNotFoundError
...
def suggest_contract(table_name: str, warehouse: str = "duckdb") -> str:
    ...
    from datapact.cli.generate import _normalise_type
